            ...
            {{-- <div class="row"> --}}
                ...
                <div class="col-lg-6">
                         <div class="row control-group">
                            <div class="form-group span1 col-xs-12 floating-label-form-group controls">
                                <label for="salutation">Salutation</label>
                                <select class="form-control input-lg" name="salutation" required>
                                    <option value="">Please Select</option>
                                    <option v-for="gender in genders" :value="Mr">Mr</option>
                                    <option v-for="gender in genders" :value="Ms">Ms</option>
                                </select>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group span3 col-xs-3 floating-label-form-group controls">
                            ...
                            <div class="form-group span3 floating-label-form-group controls">
                        ...
                        <div class="row control-group">
                            <div class="form-group span3 col-xs-12 floating-label-form-group controls">
                            ...
                            <div class="form-group span3 col-xs-12 floating-label-form-group controls" {{-- style="border: 1px solid white" --}}>
                       ...
                       {{--  <transition name="slide-fade"> --}}
                            <div id="married_form" v-if="show" style="display: none;">
                                <p style="color: #fae806; font-size: 20px;">Name of Your Spouse/Husband if Married</p>
                                <div class="row control-group">
                        ...
                        <div class="row control-group">
                            <div class="form-group span3 col-xs-12 floating-label-form-group controls" {{-- style="border: 1px solid white" --}}>
                                <label for=""></label>
                                <input type="date" class="form-control" placeholder="" name="" required data-validation-required-message="Please enter your birthday.">
                                <p class="help-block text-danger"></p>
                            </div>
