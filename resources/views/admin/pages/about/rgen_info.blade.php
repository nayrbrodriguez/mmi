...
<div class="row">
      ...
      <div class="panel-body ">
         <table id="example1" class="table table-bordered table-striped">
          ...
          @foreach($data as $key => $gen)
                      <tr>
                        {{-- <td>{!!$gen->title!!}</td> --}}
            <td><a href="{{url('admin/view_about', array($gen->id))}}" >{!!$gen->title!!}</a></td>
            {{-- <td>
    ...
    <div class="panel panel-default">
        ...
        <div class="pull-right">
      <a href="{{url('admin/edit_about',array($title->id))}}" class="btn btn-info">Edit</a>
       <a onclick="return confirm('Are you sure you want to delete {!!$title->title!!}?')" href="{{url('admin/delete_about',array($title->id))}}" class="btn btn-danger ">Delete</a>
      </div>
      ...
      <div class="panel-body">
      <h3>{!!$title->title or "About Page Title" !!}</h3> 
      <hr>
